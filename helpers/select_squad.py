...
def select_squad(players, season):
    ...
    columns = ['player_code', 'web_name', 'total_points', 'team_code', 'element_type', 'price', 'selected_by_percent', 'form', 'points_per_game', 'ict_rank', 'ep_next', 'ep_this', 'chance_of_playing_next_round', 'chance_of_playing_this_round', 'fixtures', 'history', 'history_past']
    ...
    if season == 'previous' or season is None:
        ...
        expected_scores = df['selected_by_percent']
